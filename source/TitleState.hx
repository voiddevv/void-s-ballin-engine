...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			File.saveContent(Paths.getPath("../../../../BUILD NUMBER.txt"),Std.string(Std.parseInt(engine.utills.Assets.load(TEXT, Paths.getPath("../../../../BUILD NUMBER.txt"))) + 1));
			...
			trace('build number: ${Std.parseInt(engine.utills.Assets.load(TEXT, Paths.getPath("../../../../BUILD NUMBER.txt"))) + 1}');
		}
